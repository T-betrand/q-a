...
from authentication import views as auth_user_view
...
urlpatterns = [
    ...
    # Profile system
    path('profile/', auth_user_view.profile, name="profile"),
    path('profile/update/', auth_user_view.profile_update, name="profile_update")
]
